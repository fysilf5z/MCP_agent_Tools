...
mcp = FastMCP("Demo")
#mcp = MCPServer("DevToBlogPublisher")
...
def publish_blog_to_devto(
    ...
    devto_api_key = os.getenv("DEV_TO_APIKEY")
    if not devto_api_key:
        logging.error("DEV_TO_APIKEY environment variable not set.")
        return "Error: DEV_TO_APIKEY environment variable is not set. Please set it to publish articles."
